...
namespace OrizonAI.Web.Areas.Admin.Controllers
{
    ...
    public class CompaniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Document,Active,CreatedAt")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Email,Phone,Document,Active,CreatedAt")] Company company)
        {
            if (id != company.Id)
            {
                return NotFound();
